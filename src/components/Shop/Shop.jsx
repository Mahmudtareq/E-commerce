...
const Shop = () => {
  ...
  return (
    <div>
          <h1>shop</h1>
          <div className="container mx-auto grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-1 gap-5 my-5">
        {product.map((item) => (
          <div
            key={item.id}
            data-aos="fade-up"
          ...
          >
            <div
              className="product-card-one w-full h-full rounded-md bg-white relative group overflow-hidden"
              style={{ boxShadow: "rgba(0, 0, 0, 0.05) 0px 15px 64px 0px" }}
            >
              <figure className="max-h-[200px] w-full">
                <img src={item.imageURL} alt="" className="h-[180px] w-full" />
              </figure>

              <div className="product-card-details px-[30px] pb-[20px] relative py-2">
                <div className="absolute w-full h-10 px-[30px] left-0 top-48 group-hover:top-[120px] transition-all duration-300 ease-in-out">
                  <button
                    type="button"
                    className="btn btn-neutral bg-yellow-600  w-full"
                  >
                ...
                <div>
                  <p className="py-2 hover:text-yellow-400">
                    Name: {item.name}
                  </p>
                </div>
                ...
                <p className="price">
                  <span className="main-price text-gray-700 line-through font-600 text-[18px]">
                    $27.27
                  </span>
              ...
              <div className="quick-access-btns flex flex-col space-y-2 absolute group-hover:right-4 -right-10 top-20 transition-all duration-300 ease-in-out py-2">
                <a href="#">
